      ...
      return(
              ...
              <Col sm="6" lg="3">
                ...
                <Address className="fa-ul pl-0">
                  ...
                  <li className="mb-2"><span className={"fa-li " + styles.listStyle}><i className="fab fa-linkedin text-warning"></i></span><a href="https://ca.linkedin.com/company/buy-social-canada-ccc" className="text-white">Check us out on LinkedIn</a></li>
