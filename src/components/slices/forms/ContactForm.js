	...
	render () {
		...
		return(
			<ContentBlock>
                ...
                <li className="mb-1"><span className="fa-li"><i className="fab fa-facebook text-warning"></i></span><a href="https://facebook.com/buysocialcanada.ca">Like us on Facebook</a></li>
