        ...
        {(props.slice.slice_label === "img-left")
          ...
          <Row className={`${props.slice.primary.alignment}`}>
            <Col md="5" className="mr-auto text-center">
              <img src={props.slice.primary.image.url} alt={props.slice.primary.image.alt} className="img-fluid" />
            </Col>
            <Col md="6" className="richtext">
          ...
          <Row className={`${props.slice.primary.alignment}`}>
            ...
            <Col md="5" className="ml-auto text-center">
              <img src={props.slice.primary.image.url} alt={props.slice.primary.image.alt} className="img-fluid" />
            </Col>
          </Row>
        }
